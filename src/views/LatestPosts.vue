<template>
    <section class="grid min-h-screen p-8 place-items-center bg-white">
      <div>
        <p class="font-extrabold text-4xl">Latest Posts</p>
      </div>
      <div class="container grid grid-cols-1 gap-8 my-auto lg:grid-cols-2">
        ...
        >
          <div class="relative bg-clip-border rounded-xl overflow-hidden shadow-md shadow-black bg-white text-gray-700 shadow-lg m-0">
